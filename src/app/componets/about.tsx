...
const About = () => {
  return (
    <div className="grid grid-cols-2 h-screen">
      <div className="bg-about-cafe right-0 bottom-0 w-full h-full overflow-hidden bg-center bg-no-repeat bg-contain bg-pastel3">
      ...
      <div className="relative flex flex-col h-full justify-center bg-pastel3">
        <div className="bg-about-cafe w-full h-full absolute right-0 top-0 overflow-hidden bg-no-repeat bg-center bg-contain rotate-180"></div>
