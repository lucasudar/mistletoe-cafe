    ...
    <div className="grid grid-cols-1 items-center justify-items-center px-16 py-8">
      <div className="grid grid-cols-5 items-center justify-items-center">
        <div className="flex flex-row items-center col-span-2">
          ...
          <span className="font-playfairDisplay font-bold text-3xl">Mistletoe flour & thyme</span>
        </div>
        <div className="flex flex-col justify-center gap-2">
          <h3 className="font-dmSans font-bold text-xl mb-1">Follow us</h3>
        ...
        <div className="flex flex-col justify-center items-center">
          <h3 className="font-dmSans font-bold text-xl mb-1">Contact us</h3>
